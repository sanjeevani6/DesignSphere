...
const PrintOrderPage = ({ user }) => { // Accepting user prop
    ...
    const [userDetails, setUserDetails] = useState({
        name: user ? user.name : '',  // Use user details if available
        email: user ? user.email : '', // Autofill details from user prop
        phone: user ? user.phone : '', // Autofill phone if available
